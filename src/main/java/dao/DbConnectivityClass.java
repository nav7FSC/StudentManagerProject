...
public class DbConnectivityClass {
    final static String DB_NAME="CSC311_BD_TEMP";
        ...
        final static String SQL_SERVER_URL = "jdbc:mysql://csc311singh311.mysql.database.azure.com";//update this server name
        final static String DB_URL = "jdbc:mysql://csc311singh311.mysql.database.azure.com/"+DB_NAME;//update this database name
        final static String USERNAME = "csc311admin311";// update this username
        final static String PASSWORD = "Macbook2##";// update this password
